    ...
    <div class="form-check hover-group mt-2">
        <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1">
                ...
                <div v-else>
                    <div class="user-select-none" :class="getActionClasses(action)" @dblclick="startEditing(action)"
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <button class="dropdown-item d-flex align-items-center"
                                @click="updateActionPriority(action, PRIORITY_LEVELS.LOW)"
                        ...
                        <li>
                            <button class="dropdown-item d-flex align-items-center"
                                @click="updateActionPriority(action, PRIORITY_LEVELS.MEDIUM)"
                        ...
                        <li>
                            <button class="dropdown-item d-flex align-items-center"
                                @click="updateActionPriority(action, PRIORITY_LEVELS.HIGH)"
        ...
        <div v-if="getSubActions(action.id).length > 0">
            <ActionItem v-for="subAction in getSubActions(action.id)" :key="subAction.id" :action="subAction" v-bind="{
                editingActionId,
                editingActionText,
                newSubActionText,
                getSubActions,
