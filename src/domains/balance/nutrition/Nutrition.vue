...
<template>
  <ArticleTemplate title="Nutrition Actions" meta="August 14, 2025 by G. D. Ungureanu">
    <ActionsTemplate list-id="7c2e4a8b-9f1d-4e3a-b5c6-8d9f2a1e4c7b" />
  </ArticleTemplate>

  <ArticleTemplate title="Nutrition - Ingredients Database" meta="August 14, 2025 by G. D. Ungureanu">
    <!-- Search Filter -->
    <div class="mb-4">
