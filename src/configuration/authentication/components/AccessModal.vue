    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" @click="handleCancel" :disabled="isSubmitting"></button>
        </div>

        <div class="modal-body">
          <p class="text-muted mb-3">This section requires authentication. Please enter the password to continue.</p>

          <form @submit.prevent="handleSubmit">
            <div class="mb-3">
              <label for="authPassword" class="form-label">Password</label>
              <input id="authPassword" ref="passwordInput" v-model="password" type="password" class="form-control" :class="{ 'is-invalid': error }" placeholder="Enter password" :disabled="isSubmitting" autocomplete="current-password" />
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" @click="handleCancel" :disabled="isSubmitting">Cancel</button>
          <button type="button" class="btn btn-primary" @click="handleSubmit" :disabled="isSubmitting || !isValidPassword">
